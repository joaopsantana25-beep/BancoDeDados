...
('João Silva','12345678901','11987654321','joao.silva@email.com','Rua das Flores, 123'),
('Maria Souza','23456789012','11976543210','maria.souza@email.com','Av. Paulista, 456'),
('Carlos Oliveira','34567890123','11965432109','carlos.oliveira@email.com','Rua Augusta, 789'),
('Ana Santos','45678901234','11954321098','ana.santos@email.com','Rua Vergueiro, 321'),
('Paulo Lima','56789012345','11943210987','paulo.lima@email.com','Av. Ipiranga, 654'),
('Fernanda Costa','67890123456','11932109876','fernanda.costa@email.com','Rua Consolação, 987'),
('Ricardo Alves','78901234567','11921098765','ricardo.alves@email.com','Rua Liberdade, 159'),
('Juliana Rocha','89012345678','11910987654','juliana.rocha@email.com','Av. Santo Amaro, 753'),
('Marcos Pereira','90123456789','11999887766','marcos.pereira@email.com','Rua Bela Cintra, 852'),
('Patricia Gomes','01234567890','11988776655','patricia.gomes@email.com','Rua Oscar Freire, 951');

insert into Funcionarios (nome, cargo, telefone, email) values
('Lucas Martins','Vendedor','11990000001','lucas@email.com'),
('Bruna Ferreira','Caixa','11990000002','bruna@email.com'),
('André Ribeiro','Gerente','11990000003','andre@email.com'),
('Camila Barbosa','Vendedora','11990000004','camila@email.com'),
('Diego Carvalho','Estoquista','11990000005','diego@email.com'),
('Renata Mendes','Caixa','11990000006','renata@email.com'),
('Felipe Nogueira','Vendedor','11990000007','felipe@email.com'),
('Aline Teixeira','Vendedora','11990000008','aline@email.com'),
('Gustavo Rocha','Estoquista','11990000009','gustavo@email.com'),
